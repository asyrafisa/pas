...
//        out.print(holiday_date);
        ...
        {%>
                    <script language='javascript'>
                        ...
                        window.location= 'medicalStaff.jsp';
                    </script>
        <%}
         else
        {
            ...
            {%>
                    <script language='javascript'>
                        alert('The start date you entered is in the timeframe of your previous leave period. Please choose the date after it'); 
            ...
            else
            {
                    ...
                    String sqlInsert = "INSERT INTO pms_staff_leave (user_id, hfc_cd, start_leave_date, discipline_cd, subdiscipline_cd, end_leave_date, leave_type, leave_reason, application_date, status)"
                    + "VALUES ('"+dataStaffID+"','"+dataHFCCode+"','"+startLeave+"','"+dataDiscipline+"','"+dataSubdiscipline+"','"+endLeave+"','-','"+leaveReason+"','0000-00-00','process')";
