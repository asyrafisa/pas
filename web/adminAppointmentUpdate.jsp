...
//        session.setAttribute("dateAppBefore", e41);
//        String appointmentDateBefore = (String)session.getAttribute("dateAppBefore");
    %>
...
//                                    out.print(isSelect);
            ...
            </div><div id="addAppointment" class="tab-pane fade">
...
<!--               out.print(e31);-->
                    ...
                    <div class="form-group" >
                        ...
                        <div class="col-sm-10">   
                            ...
                            {%>
                                <input name="pmiNo" value="<%= e27 %>" type="text" class="form-control" readonly>
                            <%}%>
                        </div>
                    </div> 
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">   
                            ...
                            {%>
                                <input name="appTime" value="<%= e33 %>" type="time" class="form-control" required>
                            <%}%>
                        </div>
                    </div>
                    <div class="form-group">
...
//                                  out.print(disciplineCodeApp);
                ...
                <!--</div>-->
                        ...
                        <script>
                            function alertbox()
                            {
                                alert("You have to click on Check button to check your appointment date, time and doctor");
                            }
                        </script>
...
//                                    String staffIDFromDB = dataStaffLeave.get(i).get(1);
                    ...
                    <!--<input type="hidden" name="pmiAppointmentBefore" value="<%=e38%>">-->
                    <form class="form-horizontal" role="form" method="post" action="updateAppointment.jsp">
                        <%   
                            String sql1 = "SELECT * "
                                    + "FROM pms_patient_biodata "
...
//                            out.print(sql);
                    ...
                    <div class="form-group"><label class="control-label col-sm-2" for="appDate">*Appointment Date : </label>
                        <div class="col-sm-10">   
                            <%if(e41 == null)
                            {%>
